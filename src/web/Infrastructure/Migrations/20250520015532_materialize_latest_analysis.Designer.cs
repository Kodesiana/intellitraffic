...
namespace Kodesiana.BogorIntelliTraffic.Web.Infrastructure.Migrations
{
    ...
    [Migration("20250520015532_materialize_latest_analysis")]
    partial class materialize_latest_analysis
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kodesiana.BogorIntelliTraffic.Web.Domain.Entities.AnalysisHistory", b =>
                {
                    b.HasOne("Kodesiana.BogorIntelliTraffic.Web.Domain.Entities.AnalysisResult", "Result")
                        .WithOne("History")
                        .HasForeignKey("Kodesiana.BogorIntelliTraffic.Web.Domain.Entities.AnalysisHistory", "CameraId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_analysis_histories_analysis_results_camera_id");
